...
function _removeServiceInstance(app, name, instanceIdentifier = DEFAULT_ENTRY_NAME) {
    t(app, name).clearInstance(instanceIdentifier);
}
/**
 * Test only
 *
 ...
 * @public
 */
function e(name = DEFAULT_ENTRY_NAME) {
 ...
 * @public
 */
function i(libraryKeyOrName, version, variant) {
    var _a;
    ...
    n(new Component(`${library}-version`, () => ({ library, version }), "VERSION" /* VERSION */));
}
/**
...
function registerCoreComponents(variant) {
    n(new Component('platform-logger', container => new PlatformLoggerServiceImpl(container), "PRIVATE" /* PRIVATE */));
    n(new Component('heartbeat', container => new HeartbeatServiceImpl(container), "PRIVATE" /* PRIVATE */));
    // Register `app` package.
    i(name$o, version$1, variant);
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    i(name$o, version$1, 'esm2017');
